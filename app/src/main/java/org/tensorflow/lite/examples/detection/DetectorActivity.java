                ...
                public void run() {
                  ...
                  for (final Detector.Recognition result : results) {
                    ...
                    if (location != null && result.getConfidence() >= minimumConfidence) {
                      ...
                      if(eleccion == 0) {
                        LOGGER.i("Detected " + result.getTitle());
                        tts_intent.putExtra(TTS_Service.EXTRA_TTS_TEXT, result.getTitle());
                        startService(tts_intent);
                      }
                      else {
                        LOGGER.i(result.getTitle()+ " - " + selector[eleccion]);
                        if (result.getTitle().equals(selector[eleccion])) {
                          LOGGER.i("Detected " + result.getTitle());

                          String localizacionY = "";
                          String localizacionX = "";
                          ...
                          tts_intent.putExtra(TTS_Service.EXTRA_TTS_TEXT, result.getTitle() + localizacionY + localizacionX);
                          startService(tts_intent);
                        }
                      }
